...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('dashboard') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Mass TV</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('usersvideo') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User's Videos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('adminvideo') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Admin's Video</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="{{ url('webvideo') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Website Video</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('livevideo')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Live Videos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('ondemandvideos')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>On Demand Videos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{('schedulevideo')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Schedule Live Videos</p>
                </a>
              </li>
            </ul>
          </li> 
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url('userquery')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User's Query</p>
                </a>
              </li>
          ...
          <!--     <li class="nav-item">
           ...
           <ul class="nav nav-treeview">
                <li class="nav-item">
                <a href="{{ url('approvedvideoslist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Approved Videos</p>
                </a>
              </li>
             ...
             <!-- <li class="nav-item">
                <a href="{{ url('subscriptiondetails')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Subscription Plans</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('usersubscriptiondetails')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User's Subscription Details</p>
                </a>
              </li>
               <li class="nav-item">
