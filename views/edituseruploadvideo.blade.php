...
@section('title', 'Edit User Upload Video')
 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit User Upload Video</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ url('usersvideo') }}">User Uploaded Video</a></li>
              <li class="breadcrumb-item active">Edit User Upload Video</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Edit User Upload Video Form</h3>
              ...
              <form action="{{ url('updateuseruploadvideo') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
