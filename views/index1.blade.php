<!DOCTYPE html>
   <html lang="zxx">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_upcome_tabs_wrapper">
						<ul class="nav nav-tabs" role="tablist"><li role="presentation" class="active"><a href="#best" aria-controls="best" role="tab" data-toggle="tab">Upcoming Movies</a>
							</li>
								...
								<div class="item">
									<div class="row">
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 prs_upcom_slide_first">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-up1.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
												...
												<div class="prs_upcom_movie_content_box">
													...
													<div class="prs_upcom_movie_content_box_inner_icon">
														<ul><li><a href="movie_booking.html"><i class="flaticon-cart-of-ecommerce"></i></a>
															</li>
														</ul></div>
												</div>
											</div>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 prs_upcom_slide_second">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-up2.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
															<li><a href="#">View Details</a>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-up3.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
															<li><a href="#">View Details</a>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-up4.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
															<li><a href="#">View Details</a>
										...
										<div class="cc_featured_second_section">
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-up5.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-up6.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-up7.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-up8.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="prs_animate_btn1 prs_upcom_main_wrapper">
									<ul><li><a href="#" class="button button--tamaya prs_upcom_main_btn" data-text="view all"><span>View All</span></a>
										</li>
									</ul></div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_video_sec_icon_wrapper">
						<ul><li><a class="test-popup-link button" rel="external" href="https://www.youtube.com/embed/ryzOXAO0Ss0" title="title"><i class="flaticon-play-button"></i></a>
							</li>
						</ul></div>
				</div>
			</div>
	...
	<div class="prs_upcom_slider_main_wrapper">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_upcome_tabs_wrapper">
						<ul class="nav nav-tabs" role="tablist"><li role="presentation" class="active"><a href="#best1" aria-controls="best" role="tab" data-toggle="tab">Upcoming Series</a>
							</li>
							<li role="presentation"><a href="#hot1" aria-controls="hot" role="tab" data-toggle="tab">Live Streaming</a>
							</li>
							<li role="presentation"><a href="#trand1" aria-controls="trand" role="tab" data-toggle="tab">Video On Demand</a>
							</li>
						</ul></div>
				</div>
				<div class="tab-content">
								...
								<div class="item">
									<div class="row">
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 prs_upcom_slide_first">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-ws2.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
															<li><a href="#">View Details</a>
										...
										<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 hidden-sm prs_upcom_slide_second">
											<div class="prs_upcom_movie_box_wrapper">
												<div class="prs_upcom_movie_img_box">
													<img src="{!!asset('public/assets/website/images/content-ws3.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
													<div class="prs_upcom_movie_img_btn_wrapper">
														<ul><li><a href="#">View Trailer</a>
															</li>
															<li><a href="#">View Details</a>
										...
										<div class="cc_featured_second_section">
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-ws4.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-ws5.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-ws6.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
											...
											<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 hidden-sm hidden-xs">
												<div class="prs_upcom_movie_box_wrapper">
													<div class="prs_upcom_movie_img_box">
														<img src="{!!asset('public/assets/website/images/content-ws7.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>
														<div class="prs_upcom_movie_img_btn_wrapper">
															<ul><li><a href="#">View Trailer</a>
																</li>
																<li><a href="#">View Details</a>
	...
	<!--		<ul class="album-slider"><li class="album-slider__item">-->
	<!--				<figure class="album"><div class="prs_upcom_movie_box_wrapper">-->
	<!--						<div class="prs_upcom_movie_img_box">-->
	<!--							<img src="{!!asset('public/assets/website/images/content-up1.jpg')!!}" alt="movie_img"><div class="prs_upcom_movie_img_overlay"></div>-->
	<!--							<div class="prs_upcom_movie_img_btn_wrapper">-->
	<!--								<ul><li><a href="#">View Trailer</a>-->
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="prs_ln_left_img_wrapper">
						...
						<div class="prs_prs_webseri_video_sec_icon_cont_wrapper">
							...
							<ul><li><i class="fa fa-thumbs-up"></i>&nbsp;&nbsp;<a href="#">120 Like</a>
								</li>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="prs_ln_right_first_box_wrapper">
									<div class="prs_in_right_box_img_wrapper">
										<img src="{!!asset('public/assets/website/images/content-nl2.jpg')!!}" alt="news_img"></div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="prs_ln_right_first_box_wrapper2">
									<div class="prs_in_right_box_img_wrapper">
										<img src="{!!asset('public/assets/website/images/content-nl3.jpg')!!}" alt="news_img"></div>
									<div class="prs_in_right_box_img_cont_wrapper">
										<h2><a href="#">The News of theater</a></h2>
										<h3>28 feb 2018</h3>
										<p>Lorem ipsum dolor sit amet, consectuir adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
	...
	<!--									<img src="{!!asset('public/assets/website/images/content-ft1.jpg')!!}" alt="feature_img"><div class="prs_ft_btn_wrapper">-->
	<!--										<ul><li><a href="#">Book Now</a>-->
	<!--											</li>-->
	<!--										</ul></div>-->
	<!--								</div>-->
	...
	<!--							<div class="prs_feature_img_box_wrapper">-->
	<!--								<div class="prs_feature_img">-->
	<!--									<img src="{!!asset('public/assets/website/images/content-ft2.jpg')!!}" alt="feature_img"><div class="prs_ft_btn_wrapper">-->
	<!--										<ul><li><a href="#">Book Now</a>-->
	<!--											</li>-->
	<!--										</ul></div>-->
	<!--								</div>-->
	...
	<!--							<div class="prs_feature_img_box_wrapper">-->
	<!--								<div class="prs_feature_img">-->
	<!--									<img src="{!!asset('public/assets/website/images/content-ft3.jpg')!!}" alt="feature_img"><div class="prs_ft_btn_wrapper">-->
	<!--										<ul><li><a href="#">Book Now</a>-->
	<!--											</li>-->
	<!--										</ul></div>-->
	<!--								</div>-->
			...
			<div class="row">
				...
				<div class="prs_vp_main_slider_wrapper">
					<div class="prs_vp_left_slidebar_wrapper">
						<div class="wrap-album-slider">
							<ul class="prs_vp_left_slider"><li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp1.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp1.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
								<li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp2.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp2.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
								<li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp3.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp3.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
								<li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp4.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp4.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
								<li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp5.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp5.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
								<li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp6.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp6.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
							</ul></div>
					</div>
							...
							<div class="owl-carousel owl-theme">
								<div class="item">
									<div class="prs_vp_center_slider_img_wrapper">
										<img src="{!!asset('public/assets/website/images/content-vp7.jpg')!!}" alt="vp_img"></div>
								</div>
								<div class="item">
									<div class="prs_vp_center_slider_img_wrapper">
										<img src="{!!asset('public/assets/website/images/content-vp7.jpg')!!}" alt="vp_img"></div>
					...
					<div class="prs_vp_right_slidebar_wrapper">
						<div class="wrap-album-slider">
							<ul class="prs_vp_right_slider"><li class="album-slider__item prs_vp_hover_overlay">
									<figure class="album"><div class="prs_vp_img_overlay">
											<img src="{!!asset('public/assets/website/images/content-vp6.jpg')!!}" alt="vp_img"><a href="{!!asset('public/assets/website/images/content/vp6.jpg')!!}" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall12"><i class="fa fa-search"></i></a>
										</div>
									</figure><!-- End album --></li>
					...
					<div class="prs_vp_bottom_banner_wrapper">
						<img src="{!!asset('public/assets/website/images/content-vp8.jpg')!!}" alt="banner"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<!--								<img src="{!!asset('public/assets/website/images/content-p1.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--						<div class="item">-->
	<!--							<div class="prs_pn_img_wrapper">-->
	<!--								<img src="{!!asset('public/assets/website/images/content-p2.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--						<div class="item">-->
	<!--							<div class="prs_pn_img_wrapper">-->
	<!--								<img src="{!!asset('public/assets/website/images/content-p3.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--						<div class="item">-->
	<!--							<div class="prs_pn_img_wrapper">-->
	<!--								<img src="{!!asset('public/assets/website/images/content-p4.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--						<div class="item">-->
	<!--							<div class="prs_pn_img_wrapper">-->
	<!--								<img src="{!!asset('public/assets/website/images/content-p5.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--						<div class="item">-->
	<!--							<div class="prs_pn_img_wrapper">-->
	<!--								<img src="{!!asset('public/assets/website/images/content-p6.jpg')!!}" alt="patner_img"></div>-->
	<!--						</div>-->
	<!--					</div>-->
	<!--				</div>-->
	<!--			</div>-->
