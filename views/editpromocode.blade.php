        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <form action="{{ url('updatepromocode') }}" method="post" enctype="multipart/form-data">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Promo Code Name</label>
                    <input type="text" name="promo_code_name" class="form-control" value="{{$details->promo_code_name}}" required>
                    <input type="hidden" name="id" class="form-control" value="{{$details->id}}">
                  </div>
        
                  <div class="form-group">
                    <label for="exampleInputFile">Discount</label>
                    <input type="type" name="discount" class="form-control" value="{{$details->discount}}" required>
